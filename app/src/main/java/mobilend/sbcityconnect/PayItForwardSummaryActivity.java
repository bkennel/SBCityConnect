...
public class PayItForwardSummaryActivity extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pay_it_forward_summary);
        ...
        menuButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                PopupMenu popup = new PopupMenu(PayItForwardSummaryActivity.this, menuButton);
                popup.setOnMenuItemClickListener(PayItForwardSummaryActivity.this);
